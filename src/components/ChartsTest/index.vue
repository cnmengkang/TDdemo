<template>
    <div class="container">
        <div class="list-header">
            <h1 class="title">安全合规、高速稳定的基础设施建设</h1>
            <p class="title-desc">遍布全球的基础设施节点为用户提供快速稳定、智能可靠的服务 </p>
        </div>
        <div class="map-container">
            <div id="container" class="index-container"></div>
        </div>
    </div>
</template>
...
onMounted(() => {
    ...
    if (dom) {
        ...
        console.log("EarthFlyLine 初始化成功！", chart);
    } else {
